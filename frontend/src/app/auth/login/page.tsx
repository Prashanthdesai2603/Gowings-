...
import { Mail, Lock, ArrowRight, PlaneTakeoff, Loader2 } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 pt-20 pb-12">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute top-[60%] -right-[10%] w-[30%] h-[50%] rounded-full bg-secondary/20 blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="backdrop-blur-xl bg-white/70 dark:bg-slate-900/70 border border-white/20 dark:border-white/10 p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-300 hover:shadow-[0_8px_40px_rgb(0,0,0,0.16)]">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-primary to-secondary mb-4 shadow-lg text-white transform hover:scale-105 transition-transform duration-300">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full relative group overflow-hidden bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-medium py-3 rounded-xl transition-all duration-300 hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center mt-2"
            >
              <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-primary rounded-full group-hover:w-full group-hover:h-56 opacity-10 dark:opacity-20"></span>
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <Link href="/auth/register" className="font-semibold text-primary hover:text-primary/80 transition-colors hover:underline underline-offset-4">
              Sign up
            </Link>
          </div>
        </div>
